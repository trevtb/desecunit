...
protected:
    /* The settings object */
    QSettings *settings;
    /* Controls the while loop representing the stream */
    bool active;
public:
    /** Constructor */
    HttpRequestHandler(QSettings *settings, QObject* parent=0);
    /**
    ...
    */
    virtual void service(HttpRequest& request, HttpResponse& response, QString origin = "");
